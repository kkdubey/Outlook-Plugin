...
namespace CallMeBack
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SendMessage(App, lineInfo, messageTextBox.Text, mailTextBox.Text, subjectTextBox.Text, fromTextBox.Text, nameTextBox.Text);
        }

        //this is where the application will actually send the e-mail
